...
coordinates: any;
    ...
    loadUserProfile(): void {
      this.#authService.getProfile().subscribe({
        next: (response: any) => {
          ...
          // Ahora puedo usar 'name', 'email', 'avatarUrl' en tu HTML
        },
    ...
    {
      // Asume que updatedName y updatedEmail son propiedades de los componentes vinculados a los inputs del formulario
